                    ...
                    <div>
                       ...
                       <img src={logo} className='w-1/3' alt="logo" />
                        ...
                        <ul className="mt-8 flex gap-6">
                            <li>
                                <a
                                    href="https://www.facebook.com/profile.php?id=100009856265192&locale=ar_AR"
                                    rel="noreferrer"
                                    target="_blank"
                            ...
                            <li>
                                <a
                                    href="https://www.instagram.com/zaghloul990/"
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-red-500-700 transition hover:opacity-75"
                                >
                            ...
                            <li>
                                <a
                                    href="https://www.linkedin.com/in/abdulrahmanzaghloul/"
                                    rel="noreferrer"
                                    target="_blank"
                            ...
                            <li>
                                <a
                                    href="https://github.com/AbdulrahmanAhmedZaghloul"
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-gray-700 transition hover:opacity-75"
                                >
